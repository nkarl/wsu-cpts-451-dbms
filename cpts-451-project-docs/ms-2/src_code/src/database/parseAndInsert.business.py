...
def insert2BusinessTable():
    ...
    test_data = '../../database/Yelp-CptS451/test/business.JSON'
    real_data = '../../database/Yelp-CptS451/yelp_business.JSON'
    with open(real_data, 'r') as f:
        ...
        while line:
            ...
            sql_str = "INSERT INTO business (business_id,name,address,state,city,zipcode,stars,num_reviews,num_checkins,is_open) " \
                "VALUES ('" \
