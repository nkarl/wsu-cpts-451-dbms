...
def insert2BusinessTable():
    ...
    test_data = './Yelp-CptS451/test/review.JSON'
    real_data = './Yelp-CptS451/yelp_review.JSON'
    with open(real_data, 'r') as f:
        ...
        while line:
            ...
            sql_str = "INSERT INTO review (review_id,business_id,stars,text) " \
                "VALUES ('" \
            ...
            try:
                ...
                print("INSERT INTO review TABLE failed!")
            conn.commit()
